...
const ERROR_TRANSLATIONS = [
  {
    match: /Cannot delete group: it still has profiles assigned/i,
    text: 'Không thể xóa nhóm: vẫn còn profile trong nhóm này',
  },
  ...
  {
    match: /profileIds array is required/i,
    text: 'Vui lòng chọn danh sách profile',
  },
  {
    match: /Profile is currently running automation or processing a video/i,
    text: 'Profile đang chạy tự động hoặc đang xử lý video',
  },
  {
    match: /Profile already running or processing a video/i,
    text: 'Profile đang chạy tự động hoặc đang xử lý video',
  },
  {
    match: /No matching profiles for the given selection/i,
    text: 'Không tìm thấy profile phù hợp với lựa chọn',
  },
  {
    match: /No profiles available to run/i,
    text: 'Không có profile nào khả dụng để chạy',
  },
  {
    match: /No idle profiles in selection/i,
    text: 'Không có profile nào ở trạng thái rảnh trong danh sách chọn',
  },
  {
    match: /Profile is already in login verification process/i,
    text: 'Profile đang trong quá trình xác thực đăng nhập',
  },
  {
    match: /Profile is not in login process/i,
    text: 'Profile không ở trong quá trình đăng nhập',
  },
  {
    match: /Profile is already adding favorite music/i,
    text: 'Profile đang trong quá trình thêm nhạc yêu thích',
  },
  {
    match: /Failed to launch browser:?\s*(.*)/i,
    text: 'Không thể khởi chạy trình duyệt: $1',
  },
  {
    match: /Failed to close browser:?\s*(.*)/i,
    text: 'Không thể đóng trình duyệt: $1',
  },
  ...
  {
    match: /Profile renamed successfully/i,
    text: 'Đổi tên profile thành công',
  },
  ...
  {
    match: /Failed to update profile group/i,
    text: 'Không thể cập nhật nhóm cho profile',
  },
  ...
  {
    match: /Failed to add favorite music/i,
    text: 'Không thể thêm nhạc yêu thích',
  },
  {
    match: /Folder selection cancelled or failed/i,
    text: 'Đã hủy chọn thư mục',
  },
  { match: /No folder selected/i, text: 'Chưa chọn thư mục nào' },
  { match: /Body must be an object/i, text: 'Dữ liệu cấu hình không hợp lệ' },
  {
    match: /Both video_id and channel_id are required/i,
    text: 'Cần có cả video_id và channel_id',
  },
  {
    match: /No profile found managing channel ID/i,
    text: 'Không tìm thấy profile nào quản lý channel ID này',
  },
  { match: /Network Error/i, text: 'Lỗi kết nối mạng đến máy chủ' },
  {
    match: /Request failed with status code 500/i,
    text: 'Máy chủ gặp sự cố (500) khi xử lý yêu cầu',
  },
  {
    match: /Request failed with status code 400/i,
    text: 'Yêu cầu không hợp lệ (400)',
  },
  {
    match: /Request failed with status code 404/i,
    text: 'Không tìm thấy dữ liệu yêu cầu (404)',
  },
  {
    match: /Request failed with status code (\d+)/i,
    text: 'Yêu cầu thất bại với mã lỗi $1',
  },
];
